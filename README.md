...
- [Sulaiman-Dauda/windlass](https://github.com/Sulaiman-Dauda/windlass) - Lightweight self-hosted Docker Compose control plane: projects, Git deployments, HTTPS domains, logs and backups. Wraps the real docker compose rather than replacing it, so your containers keep runnin
...
- [cuong-tran/manga-repo](https://github.com/cuong-tran/manga-repo) - Extensions for Komikku / Mihon & forks.
...
- [afonsofrancof/OSC11.nvim](https://github.com/afonsofrancof/OSC11.nvim) - A tiny Neovim plugin for automatic light and dark terminal theme synchronization via OSC 11.
...
- [yutkat/term-gf.nvim](https://github.com/yutkat/term-gf.nvim) - Neovim plugin that opens filenames under the cursor from terminal buffers with gf
...
- [santigo-dev/right-corner-diagnostics.nvim](https://github.com/santigo-dev/right-corner-diagnostics.nvim) - Show diagnostics at the right corner of the buffer
...
- [TooTallNate/plist.js](https://github.com/TooTallNate/plist.js) - Apple property list parser/builder for Node.js and browsers — supports XML, binary (bplist), and OpenStep formats
...
- [rob-odwyer/logstash.vim](https://github.com/rob-odwyer/logstash.vim) - highlights logstash configuration files
